...
a persistence unit "EJBClienteRemotoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "EJBClienteRemoto/pom.xml":
...
artifact ("EJBClienteRemoto.war") is already built. You can build
