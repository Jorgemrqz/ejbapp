...
a persistence unit "EJBRemotoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "EJBRemoto/pom.xml":
...
artifact ("EJBRemoto.war") is already built. You can build
